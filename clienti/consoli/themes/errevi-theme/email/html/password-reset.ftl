    ...
    <tr>
      <td align="center">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:620px;background:#ffffff;border-radius:18px;overflow:hidden;border:1px solid #e4e7eb;box-shadow:0 10px 28px rgba(0,0,0,0.08);">
          <tr>
            <td style="background:#0f1115;padding:28px 30px;text-align:center;">
              <img src="${msg('emailLogoUrl')}" width="220" alt="${msg('companyName')}" style="display:inline-block;max-width:220px;width:100%;height:auto;border:0;outline:none;text-decoration:none;">
            </td>
          </tr>
          <tr>
            <td style="padding:34px 34px 22px 34px;">
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin:28px 0 26px 0;">
                <tr>
                  <td align="center" bgcolor="#e6007e" style="border-radius:999px;">
                    <a href="${resetLink}" style="display:inline-block;padding:14px 28px;font-size:16px;font-weight:700;line-height:1.2;color:#ffffff;text-decoration:none;border-radius:999px;background:#e6007e;">${msg("resetButton")}</a>
                  </td>
                </tr>
              </table>
              ...
              <div style="margin:24px 0 0 0;padding:16px;background:#f7f8fa;border-radius:12px;border:1px solid #e8eaee;">
                ...
                <a href="${resetLink}" style="font-size:13px;line-height:1.5;color:#e6007e;word-break:break-all;text-decoration:none;">${resetLink}</a>
              </div>
            </td>
          </tr>
          <tr>
            <td style="padding:22px 34px 30px 34px;background:#fafafa;border-top:1px solid #edf0f2;">
              ...
              <p style="margin:0;font-size:13px;line-height:1.6;color:#6b7280;">
                <strong>${msg("companyName")}</strong><br>
                ${msg("companyAddress")}<br>
                ${msg("companyPhone")} · <a href="mailto:${msg('companyEmail')}" style="color:#e6007e;text-decoration:none;">${msg("companyEmail")}</a><br>
                <a href="${msg('companyWebsite')}" style="color:#e6007e;text-decoration:none;">${msg("companyWebsite")}</a>
              </p>
            </td>
          </tr>
        </table>
