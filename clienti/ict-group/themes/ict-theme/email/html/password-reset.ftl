      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:620px;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e6eaf2;box-shadow:0 10px 30px rgba(47,52,66,0.10);">
        ...
        <tr>
          <td style="padding:0 38px 34px;">
            <h1 style="margin:0 0 18px;font-size:24px;line-height:1.25;font-weight:800;color:#2f3442;">${msg("resetTitle")}</h1>
            <p style="margin:0 0 14px;font-size:14px;line-height:1.6;color:#3f4652;">${msg("emailGreeting")}</p>
            <p style="margin:0 0 14px;font-size:14px;line-height:1.6;color:#3f4652;">${msg("resetIntro")} <strong>${realmName}</strong>.</p>
            <p style="margin:0 0 24px;font-size:14px;line-height:1.6;color:#3f4652;">${msg("resetHelp")}</p>
            <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
              <tr>
                <td bgcolor="#4547d9" style="border-radius:12px;">
                  <a href="${link}" style="display:inline-block;padding:13px 22px;background:#4547d9;color:#ffffff;font-size:13px;line-height:1;font-weight:800;text-transform:uppercase;letter-spacing:.06em;text-decoration:none;border-radius:12px;">${msg("resetButton")}</a>
                </td>
              </tr>
            </table>
            ...
            <p style="margin:0 0 22px;font-size:13px;line-height:1.55;color:#6f7480;">${msg("resetIgnore")}</p>
