...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('username','password') displayInfo=realm.password && realm.registrationAllowed && !registrationDisabled??; section>
    ...
    <#elseif section = "form">
        ...
        <#-- ============================================================
             POMA — Avviso accesso riservato B2B (solo tema Poma)
             ============================================================ -->
        <div id="poma-b2b-notice" class="poma-b2b-notice" role="note">
            <p class="poma-b2b-notice__lead">${kcSanitize(msg("pomaB2bNoticeLead"))?no_esc}</p>
            <p class="poma-b2b-notice__row">${kcSanitize(msg("pomaB2bNoticeClient"))?no_esc}</p>
            <p class="poma-b2b-notice__row">${kcSanitize(msg("pomaB2bNoticePrivate"))?no_esc}</p>
        </div>
